...
echo "</th>";
echo "<td>";
echo "<input type='number' name='scharge' min= '0' max= '16'  value=".toBrikker($row["Start"])."><br>";
echo "</td>";
echo "</tr>";
echo "<tr>";
echo "<th>";
...
echo "</th>";
echo "<td>";
echo "<input type='number' name='echarge' min= '0' max= '16'  value=".toBrikker($row["Slutt"])."><br>";
echo "</td>";
echo "</tr>";
echo "<tr>";
echo "<th>";
...
echo "</th>";
echo "<td>";
echo "<input type='date' name='date' value=".$row["Dato"]."><br>";
echo "</td>";
echo "</tr>";
echo "<tr>";
echo "<td>";
